...
class SimulationGameControllerTest extends EasyMockSupport {
    ...
    void testPlaceShipsNoShips() {
        ...
        IllegalArgumentException ex = assertThrows(IllegalArgumentException.class,
                () -> simulationGameController.placeShips(new Player("Edu", emptyList), table));
    ...
    void testPlaceShipsListShipsNull() {
        IllegalArgumentException ex = assertThrows(IllegalArgumentException.class,
                () -> simulationGameController.placeShips(new Player("Edu", null), table));
    ...
    void testPlaceShipsNoTable() {
        IllegalArgumentException ex = assertThrows(IllegalArgumentException.class,
                () -> simulationGameController.placeShips(new Player("Edu", listShips), null));
    ...
    void testPlaceShipsBien() {
        ...
        expect(gameMock.tryPlaceShip(anyObject(Player.class), anyObject(Table.class), anyObject(Ship.class)))
    ...
    void testTryPlaceShip_Normal() throws Exception {
        ...
        boolean estado = simulationGameController.tryPlaceShip(new Player("raul", listShips), table, listShips.get(0));
    ...
    void testTryPlaceShip_OVERLAPP() throws Exception {
        ...
        boolean estado = simulationGameController.tryPlaceShip(player, table, shipSinPos);
